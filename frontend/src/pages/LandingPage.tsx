...
import { Sparkles, ArrowRight, Zap, Cpu, GraduationCap } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-6 py-20 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="col-span-1 lg:col-span-6 flex flex-col items-start gap-6">
            ...
            >
              ...
              Meet <span className="bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-indigo-500">Intelligent LMS.</span>
            </motion.h1>
            ...
            >
              SmartLearn AI bridges simulated database tracking with neural network assistants. Perform GPA prediction checks, analyze career choices, and publish note summaries on a breathtaking dark glass layout.
            </motion.p>
          ...
          <div className="col-span-1 lg:col-span-6 relative flex justify-center">
            ...
            >
              <img 
                ...
                onError={(e) => {
                  // Fallback graphics template in case SVGs are missing
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-32 relative z-20">
          <div className="p-8 bg-slate-900/30 border border-slate-800/40 rounded-2xl backdrop-blur-sm hover:border-violet-500/20 transition-all flex flex-col gap-4">
            ...
            <h4 className="font-bold text-base text-white">Advisory Neural Modules</h4>
            <p className="text-[11px] text-slate-400 font-semibold leading-relaxed">
              Activate distinct AI models matching coding tutors, career matchers, or mental check disclaimers instantly.
            </p>
          </div>
          ...
          <div className="p-8 bg-slate-900/30 border border-slate-800/40 rounded-2xl backdrop-blur-sm hover:border-violet-500/20 transition-all flex flex-col gap-4">
            ...
            <h4 className="font-bold text-base text-white">Live Sockets Broadcasts</h4>
            <p className="text-[11px] text-slate-400 font-semibold leading-relaxed">
              Experience instant reactive broadcasts on grade completions, notes publishing, or comments additions.
            </p>
          </div>
          ...
          <div className="p-8 bg-slate-900/30 border border-slate-800/40 rounded-2xl backdrop-blur-sm hover:border-violet-500/20 transition-all flex flex-col gap-4">
            ...
            <h4 className="font-bold text-base text-white">GPA Slider Math Optimizer</h4>
            <p className="text-[11px] text-slate-400 font-semibold leading-relaxed">
              Slide estimated course marks to watch cumulative semester project GPAs calculate dynamically on visual nodes.
            </p>
          </div>
        </section>
      </main>
