  ...
  return (
    <div className="flex-grow p-8 overflow-y-auto max-h-screen relative">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <span className="text-violet-500 font-bold text-xs uppercase tracking-wider">Faculty Workspace</span>
          <h2 className="text-2xl font-black font-sans mt-1">Lecturer Portal Hub</h2>
        </div>
